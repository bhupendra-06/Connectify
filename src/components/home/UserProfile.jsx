...
const UserProfile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <Link onClick={() => navigate(-1)}>{/* go to previous page in the routing path */}
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6 border-b pb-6">
        ...
        <div className="w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden">
          <img
            src="https://images.pexels.com/photos/14454192/pexels-photo-14454192.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt="User Avatar"
        ...
        <div className="flex-1 text-center md:text-left">
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-2 md:space-y-0 md:space-x-4 mb-4">
            <h1 className="text-2xl font-bold">deepak_here</h1>
          ...
          <div className="mt-4">
            ...
            <p className="text-sm">
              This is a short bio about the user. They can add a description
